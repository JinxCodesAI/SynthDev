...
describe.sequential('Snapshot Workflow Integration', () => {
    ...
    describe('error handling', () => {
        it('should handle non-existent snapshot IDs', async () => {
            await expect(snapshotManager.restoreSnapshot('non-existent-id')).rejects.toThrow(
                'Snapshot not found'
            );
            await expect(snapshotManager.deleteSnapshot('non-existent-id')).rejects.toThrow(
                'Snapshot not found'
            );
            await expect(snapshotManager.getSnapshotDetails('non-existent-id')).rejects.toThrow(
                'Snapshot not found'
            );
        });
