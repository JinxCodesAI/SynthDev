...
For developers who want to modify SynthDev:
...
- **[Tool Development](../development/tools-development.md)**: How to create and modify tools
- **[ADRs](../development/ADRs/)**: Architecture Decision Records for development patterns
