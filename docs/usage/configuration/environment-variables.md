...
| ------------------------------------ | ------- | ------------------------- | -------------------------- |
| `SYNTHDEV_API_KEY`                   | string  | _required_                | API key for base model     |
...
| `SYNTHDEV_SMART_API_KEY`             | string  | _optional_                | API key for smart model    |
| `SYNTHDEV_SMART_MODEL`               | string  | _optional_                | Smart model name           |
| `SYNTHDEV_SMART_BASE_URL`            | string  | _optional_                | Smart model API URL        |
| `SYNTHDEV_FAST_API_KEY`              | string  | _optional_                | API key for fast model     |
| `SYNTHDEV_FAST_MODEL`                | string  | _optional_                | Fast model name            |
| `SYNTHDEV_FAST_BASE_URL`             | string  | _optional_                | Fast model API URL         |
